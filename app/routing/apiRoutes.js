...
var api = function (app) {
    ...
    app.post("/api/friends", function (req, res) {
        ...
        // this array will hold the difference between current user's scores against those from other users, question by question using absolute value
        var diffs = [];

        // this array will be used to hold the total difference between each of the other users and the current user
        var totalDiffs = [];

        // function to loop through each of the scores array in each friend object in the friends array and calculates the absolute differences
